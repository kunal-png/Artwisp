...
<section>
    ...
    <!-- <nav aria-label="breadcrumb">
      ...
      <h1 class="page-heading text-center p-2 ">Originals</h1>
      ...
      data-masonry='{"percentPosition": true }'>
        ...
        while($row=mysqli_fetch_assoc($result_query)){
          ...
          <div class='card-body p-0'>
            ...
            <br>
            <a href='originals.php?add_to_cart=$product_id' class='btn btn-primary w-100 add-btn fw-medium p-3'>Add to Cart</a>
          </div>
        </div>
          ";
        }
